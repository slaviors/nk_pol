      ...
      <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-8 md:p-10 border-2 border-gray-100 hover:border-red-600/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <FormTextarea
            ...
            placeholder="Ceritakan kebutuhan stand pameran Anda..."
            rows={5}
            required
          />
          ...
          <button
            ...
            className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
          >
            {isSubmitting ? (
              <>
